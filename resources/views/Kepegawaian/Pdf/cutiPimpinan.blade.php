...
<body>
    <table style="width: 100%; border: none;">
        <tr>
            <td width="250"></td>            
            <td colspan="2" style="text-align: left; margin-top: 20px;">Lhokseumawe, '.$data['tgl'].'</td>
        </tr>
        <tr>
            <td width="250"></td>
        ...
        <tr>
            <td colspan="3"  style="text-align: center;"><strong><br>FORMULIR PERMINTAAN DAN PEMBERIAN CUTI<br>Nomor:</strong></td>
        </tr>
    </table>
    ...
    <table style="width: 100%; border: 1px solid black; border-collapse: collapse;">
        ...
        <tr>
            ...
            <td width="38%" style="border: 1px solid black;">&nbsp;Rinaldi S.H.I.</td>
            <td width="12%" style="border: 1px solid black;">&nbsp;NIP</td>
            <td width="38%" style="border: 1px solid black;">&nbsp;198101282009041005</td>
        </tr>
        <tr>
            <td width="12%" style="border: 1px solid black;">&nbsp;Jabatan</td>
            <td width="38%" style="border: 1px solid black;">&nbsp;Panitera Muda Gugatan</td>
            <td width="12%" style="border: 1px solid black;">&nbsp;Masa Kerja</td>
            <td width="38%" style="border: 1px solid black;">&nbsp;15 Tahun dan 2 Bulan</td>
        </tr>
        <tr>
    ...
    <table style="width: 100%; border: 1px solid black; border-collapse: collapse;">
        ...
        <tr>
            ...
            <td width="12%" style="border: 1px solid black; text-align: center;">V</td>
    ...
    <table style="width: 100%; border: 1px solid black; border-collapse: collapse;">
        ...
        <tr>
            ...
            <td style="width:26%; border: 1px solid black;">&nbsp;2 ( Dua ) Hari Kerja</td>
            <td style="width:16%; border: 1px solid black;">&nbsp;Mulai tanggal</td>
            <td style="width:20%; border: 1px solid black;">&nbsp;25-07-2024</td>
            <td style="width:6%; border: 1px solid black;">&nbsp;s.d</td>
            <td style="width:20%; border: 1px solid black;">&nbsp;26-07-2024</td>
        </tr>
    </table>
    <br/>
    <table style="width: 100%; border: 1px solid black; border-collapse: collapse;">
        ...
        <tr>
            ...
            <td style="width:12%; border: 1px solid black; text-align: center;">6</td>
    ...
    <table style="width: 100%; border: 1px solid black; border-collapse: collapse;">
        <tr>
            <td colspan="4" style="border: 1px solid black;"><strong>&nbsp;VI. ALAMAT SELAMA MENJALANKAN CUTI</strong></td>
        </tr>
        <tr>
            <td style="width:50%; border: 1px solid black; text-align: left;" rowspan="2" colspan="2">&nbsp;Jl. Kebon Jeruk No. 123, Jakarta</td>
            <td style="width:10%; border: 1px solid black;">&nbsp;TELP</td>
            <td style="width:40%; border: 1px solid black;">&nbsp;081360234005</td>
        </tr>
        <tr>
            <td colspan="2">&nbsp;Hormat Saya<br><br><em>&nbsp;(e-Sign)</em><br><strong>&nbsp;Rinaldi S.H.I.</strong><br><strong>&nbsp;NIP. 198101282009041005</strong></td>
        </tr>
    </table>
    <br/>
    <table style="width: 100%; border: 1px solid black; border-collapse: collapse;">
        <tr>
            <td colspan="4" style="border: 1px solid black;"><strong>&nbsp;VII. PERTIMBANGAN ATASAN LANGSUNG**</strong></td>
        </tr>
        <tr>
            ...
            <td style="width:50%; border: 1px solid black;">&nbsp;TIDAK DISETUJUI</td>
        </tr>
        <tr>
            <td style="width:16%; border: 1px solid black; text-align: center;">V</td>
            <td style="width:16%; border: 1px solid black; text-align: center;"></td>
        ...
        <tr>
            ...
            <td style="border: 1px solid black;" colspan="1">&nbsp;Jabatan<br><br><em>&nbsp;(e-Sign)</em><br><strong>&nbsp;Fauzi S.Ag</strong><br><strong>&nbsp;NIP. 197112191999031003</strong></td>
        </tr>
    </table>
    <br/>
    <table style="width: 100%; border: 1px solid black; border-collapse: collapse;">
        <tr>
            <td colspan="4" style="border: 1px solid black;"><strong>&nbsp;VIII. KEPUTUSAN PEJABAT YANG BERWENANG MEMBERIKAN CUTI</strong></td>
        </tr>
        <tr>
            <td style="width:16%; border: 1px solid black;">&nbsp;DISETUJUI</td>
            <td style="width:16%; border: 1px solid black;">&nbsp;PERUBAHAN</td>
        ...
        <tr>
            <td colspan="3" style="width:50%; border: 1px solid black; text-align: center;"></td>
            <td style="width:50%; border: 1px solid black;">Jabatan<br><br><em>&nbsp;(e-Sign)</em><br><strong>&nbsp;Yedi Suparman S.H.I. M.H.</strong><br><strong>&nbsp;NIP. 197606062005021001</strong></td>
        </tr>
    </table>
</body>
</html>
