...
<body>
    ...
    <table style="width: 100%; border: 1px solid black; border-collapse: collapse;">
        ...
        <tr>
            ...
            <td width="38%" colspan="3" style="border: 1px solid black;">&nbsp;{{ $data['name'] }}</td>
           
        </tr>
        <tr>
            <td width="12%" style="border: 1px solid black;">&nbsp;Jabatan</td>
            <td width="38%" colspan="3" style="border: 1px solid black;">&nbsp;{{ $data['jabatan'] }}</td>
         
        </tr>
        <tr>
            <td width="12%" style="border: 1px solid black;">&nbsp;Unit Kerja</td>
            <td width="38%" colspan="3" style="border: 1px solid black;">&nbsp;{{ $data['instansi']}}</td>
    ...
    <table style="width: 100%; border: 1px solid black; border-collapse: collapse;">
        ...
        <tr>
            ...
            <td width="12%" colspan="3" style="border: 1px solid black; text-align: center;">
                @if ($data['jenis'] === 'CT')
                    V
                @endif
            </td>
        ...
        <tr>
            <td width="38%" style="border: 1px solid black;">&nbsp;2. Cuti Melahirkan</td>
            <td width="12%" colspan="3" style="border: 1px solid black; text-align: center;">
                @if ($data['jenis'] === 'CM')
                    V
                @endif
    ...
    <table style="width: 100%; border: 1px solid black; border-collapse: collapse;">
        ...
        <tr>
            ...
            <td rowspan="3" style="width:45%; border: 1px solid black;">&nbsp;2. CUTI MELAHIRKAN</td>
            <td rowspan="3" style="width:15%; border: 1px solid black;"></td>
        </tr>
        <tr>
    ...
    <table style="width: 100%; border: 1px solid black; border-collapse: collapse;">
        ...
        <tr>
            <td colspan="2">&nbsp;Hormat Saya<br><br><br><em>&nbsp;(e-Sign)</em><br><strong>&nbsp;{{ $data['name'] }}</strong></td>
            <td style="width:20%; border: 1px solid black; text-align: center;">
                
                <img src="data:image/png;base64, {!! $data['qrCodePpnpn'] !!}">
            </td> 
        </tr>
    </table>
    <br/>
    <table style="width: 100%; border: 1px solid black; border-collapse: collapse;">
        <tr>
            <td colspan="3" style="border: 1px solid black;"><strong>&nbsp;VII. PERSETUJUAN KUASA PENGGUNA ANGGARAN*</strong></td>
        </tr>
        <tr>
            <td style="width:50%; border: 1px solid black;">&nbsp;DISETUJUI</td>           
        ...
        <tr>
            ...
            <td style="width:20%; border: 1px solid black; text-align: center;">
                ...
                <img src="data:image/png;base64, {!! $data['qrCodeKPA'] !!}">
            </td> 
        </tr>
    </table>        
</body>
