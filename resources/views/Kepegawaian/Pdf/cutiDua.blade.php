...
<body>
    <table style="width: 100%; border: none;">
        ...
        <tr>
            <td width="250"></td>
            <td colspan="2" style="text-align: left;">Yth. {{ $data['jabatanpim'] }} Mahkamah Syar&rsquo;iyah Lhokseumawe</td>
        </tr>
        <tr>
            <td width="250"></td>
    ...
    <table style="width: 100%; border: 1px solid black; border-collapse: collapse;">
        ...
        <tr>
            <td width="12%" style="border: 1px solid black; padding: 4px;">Unit Kerja</td>
            <td width="38%" style="border: 1px solid black; padding: 4px;">{{ $data['instansi'] }}</td>            
