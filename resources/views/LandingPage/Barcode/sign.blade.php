          ...
          <div class="container">
            <div class="hero-text-box text-center">               
                <div class="d-flex align-items-center flex-column">
                    <img class="img-fluid rounded my-4" src="{{ asset('assets') }}/img/avatars/{{ $user_detail->image }}" height="110" width="110" alt="User avatar" />
                </div>
                <div class="card mb-3">
                    <div class="card-header align-items-center">
                        <h5 class="card-action-title mb-0">
                            <span class="text-success">
                                {{ $user_detail->kelamin == 'L' ? 'Bapak' : 'Ibu' }} {{ $user_detail->name ?? 'Nama tidak tersedia' }} telah menandatangani dokumen ini dengan eSign. Berikut adalah detail dokumen:
                            </span>
                        </h5>
                    </div>
                </div>                
