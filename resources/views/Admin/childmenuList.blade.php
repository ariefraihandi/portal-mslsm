    ...
    <div class="row g-4">
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 order-0 order-md-1">
        <ul class="nav nav-pills flex-column flex-md-row mb-3">
          ...
          <li class="nav-item col-3">
              <a class="nav-link active" href="/admin/menu/childmenulist"><i class="bx bx-menu-alt-right me-1"></i>Child Menu</a>
          </li>
          <li class="nav-item col-3">
...
<script>
    function moveItem(id, direction, event) {
    event.preventDefault();
    $.ajax({
        url: '/move-childsubmenu',
        type: 'POST',
        data: {
            id: id,
            direction: direction,
