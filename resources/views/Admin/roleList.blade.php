      ...
      <div class="col-xl-12 col-lg-12 col-md-12 order-0 order-md-1">
        <ul class="nav nav-pills flex-column flex-md-row mb-3">
          <li class="nav-item col-3">
              <a class="nav-link" href="/admin/menu/menulist"><i class="bx bx-menu-alt-left me-1"></i>Menu</a>
          </li>
          <li class="nav-item col-3">
          ...
          <li class="nav-item col-3">
            <a class="nav-link active" href="/admin/menu/role"><i class="bx bx-lock-open-alt me-1"></i>Role</a>
        </li>
        </ul>
        <!-- Role Table -->
        <div class="card">
            <div class="card-datatable table-responsive">
                <table id="role-table" class="datatables-users table border-top">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Role Name</th>
...
<div class="modal fade" id="modalAddRoles" tabindex="-1" aria-labelledby="modalAddRolesLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalAddRolesLabel">Add Role</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
    ...
    @foreach($roleList as $data)
        <div class="modal fade" id="editRole_{{ $data->id }}" tabindex="-1" aria-labelledby="editRoleModalLabel_{{ $data->id }}" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editRoleModalLabel_{{ $data->id }}">Edit Role</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('role.edit') }}" method="POST">
                            ...
                            <div class="form-group">
                                <label for="role_name_{{ $data->id }}">Role Name</label>
                                <input type="text" class="form-control" id="role_name_{{ $data->id }}" name="role_name" value="{{ $data->name }}">
                            </div>
