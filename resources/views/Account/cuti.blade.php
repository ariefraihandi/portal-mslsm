    ...
    <div class="row">   
      <div class="col-xl-12 col-lg-12 col-md-12 order-0 order-md-1">
        <ul class="nav nav-pills flex-column flex-md-row mb-3">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="{{ route('user.account.cuti') }}"
    ...
    <div class="modal fade" id="cutiTahunan" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form id="formcuti" method="post" action="#">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col mb-3">
                                <label for="title" class="form-label">Nama</label>
                                <input type="text" id="title" name="title" required class="form-control" value="{{$users->detail->name}}" readonly />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col mb-3">
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <textarea id="alcut" name="alcut" class="form-control" placeholder="Alasan Pengajuan Cuti"></textarea>
                            </div>
                        </div>
                        <div class="row">
                          <div class="col mb-3">
                    ...
                    <input type="hidden" id="id_pegawai" name="id_pegawai" class="form-control" value="12345" />
