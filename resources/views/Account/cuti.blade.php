...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">   
      <div class="col-xl-12 col-lg-12 col-md-12 order-0 order-md-1">
        ...
        <div class="row">
          @if($users->detail->jabatan != 'PPNPN' && $users->detail->kelamin == 'P')
          ...
          @endif
          @if($users->detail->jabatan != 'PPNPN' && $users->detail->kelamin == 'L')
            <div class="col-sm-6 col-lg-3 mb-4">
              <div class="card card-border-shadow-primary h-100">
                <div class="card-body">
                  <div class="d-flex align-items-center mb-2 pb-1">
            ...
            <div class="col-sm-6 col-lg-3 mb-4">
                <div class="card card-border-shadow-info h-100">
                  <div class="card-body">
                    ...
                    <h5 class="mb-1">Cuti Besar</h5>
                    <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#cutiTahunan" data-jenis="CB">
                      Ajukan Cuti Besar
                    </button>                   
                  </div>
                </div>
            ...
            <div class="col-sm-6 col-lg-6 mb-4">
              <div class="card card-border-shadow-info h-100">
                <div class="card-body">
                  ...
                  <h5 class="mb-1">Cuti Melahirkan</h5>
                  <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#cutiTahunan" data-jenis="CM">
                    Ajukan Cuti Melahirkan
                  </button>                   
                </div>
              </div>
            </div>                 
